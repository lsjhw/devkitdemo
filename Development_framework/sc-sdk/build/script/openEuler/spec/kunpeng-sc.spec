...
cp %{SOURCE4} ${BuildDir}/
tar -xf ${BuildDir}/bisheng-jdk-8u372-tee-aarch64.tar.gz
cp %{SOURCE5} ${BuildDir}/
tar -xf ${BuildDir}/Python-3.6.15-tee-aarch64.tar.gz
...
cp -rf ${BuildDir}/bisheng-jdk-8u372-tee-aarch64 ${UsrLocal}/%{name}/java/
cp -rf ${BuildDir}/Python-3.6.15-tee-aarch64 ${UsrLocal}/%{name}/python/
...
/usr/local/%{name}/java/bisheng-jdk-8u372-tee-aarch64/jdk.tar.gz
/usr/local/%{name}/python/Python-3.6.15-tee-aarch64/python.tar.gz
